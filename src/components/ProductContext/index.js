    ...
    <>
      <div className="modal__product">
        ...
        <div className="modal__product-content">
          ...
          <h1 className="modal__product-title">{title}</h1>
          <p className="modal__product-description">{desc}</p>
          <div className="modal__product-label">
            <span className="modal__product-weight">Weight</span>
            <span className="modal__product-reset" onClick={handleReset}>
              x Clear
            </span>
          </div>
          ...
          {selectedStock < 1 && (
            <div className="modal__product-stockless">Out of stock</div>
          )}
