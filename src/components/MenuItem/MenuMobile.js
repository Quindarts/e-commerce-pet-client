        ...
        >
          <div className="menuui_header">
            <div className="menuui_header_close">
              ...
              >
                <Icon width="30" height="30" icon="mingcute:close-fill" />
              </span>
            </div>
          </div>
          <div
            ...
            style={{
              width: widthEl * 2,
              transform: `translateX(${Boolean(tagMenu) ? '-50%' : '0%'})`,
            }}
          >
            <div className="menuui_content_item" style={{ width: widthEl }}>
                ...
                {dataMenu &&
                  dataMenu.navigation.map((item, index) => {
                    if (item && item.isHtml) {
                      ...
                      return (
                        <li className="menuui_content_item_ul_lin" key={index}>
                          <span
                            onClick={() => {
                              setTagMenu(item.tag)
                              if (Boolean(item.tag)) {
            ...
            <div
              ...
              style={{
                width: widthEl,
                transform: `translateX(${Boolean(tagMenuC2) ? '-100%' : '0'})`,
              }}
            >
              {Boolean(tagMenu) && (
                <>
                  <div
                    style={{
                      height: '100%',
                      display: 'flex',
                      width: Boolean(tagMenuC2) ? widthEl * 2 : widthEl,
                    }}
                  >
                    <ul
                      className="menuui_content_item-wrap_ul"
                      style={{
                        width: Boolean(tagMenuC2) ? widthEl : widthEl,
                      }}
                    >
                      ...
                      {dataMenuC2 &&
                        dataMenuC2[tagMenu]?.list?.map((item, index) => {
                          return (
                            <li
                    ...
                    {Boolean(tagMenuC2) && (
                      ...
                      >
                        {Boolean(tagMenuC2) &&
                          dataMenuC3[tagMenuC2]?.list?.map((item, index) => {
                            return (
                              <li
                                className="menuui_content_item-wrap_ul_lin"
                                key={index}
          ...
          <div className="menuui_footer">
            <div style={{ display: 'block' }} className="navigation--right">
